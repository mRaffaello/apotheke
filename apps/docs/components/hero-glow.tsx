/**
 * Subtle ambient radial glow behind the hero showcase. Decorative only — set
...
export function HeroGlow() {
    ...
    // Deterministic from defaults, but gated to avoid any hydration drift.
    ...
    return (
        <div aria-hidden className='pointer-events-none absolute inset-0 z-0'>
            ...
            <div
                ...
                style={{
                    background: `radial-gradient(${g.sizeX}% ${g.sizeY}% at ${g.x}% ${g.y}%, ${hexToRgba(g.color, g.intensity)}, transparent 70%)`
                }}
            />
...
/**
 * 4x4 ordered Bayer pattern (black pixels at threshold cells < 8). Tiled at 4px
 * with pixelated rendering, it reads as a crisp ordered dither that breaks up
 * gradient banding.
 */
const DITHER_URL =
